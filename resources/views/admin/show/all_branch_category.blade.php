                                                            ...
                                                            {{ csrf_field() }}
                                                                <div class="card-body">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control" name="id_category_main" id="id_category_main" placeholder="ID Catergory Main">
                                                                    </div>
                                                                    <div class="form-group">
                                                                    ...
                                                                    <textarea style="resize: none" rows="8" class="form-control" name="branch_descr"
                                                                            id="branch_descr" placeholder="Description branch"></textarea>
                                                                    </div>
                                                                ...
                                                                <!-- /.card-body -->
                                                                    ...
                                                                    <button type="submit" name="add_branch" class="btn btn-primary">Add New Branch</button>
                                                                    </div>
                                                            </form>
                                                        </div>
                                                    </div>
