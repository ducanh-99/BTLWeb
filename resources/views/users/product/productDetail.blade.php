        ...
        <div class="row d-flex align-items-center flex-wrap">
            ...
            <div class="col-md-5">
                <ul class="breadcrumb d-flex justify-content-end">
                    ...
                    <li class="breadcrumb-item"><a href="{{URL::to('/branch-result/'.$queryy->id_category_main)}}">{{$categoryMainOnly->name}}</a>
                    </li>
                    <li class="breadcrumb-item"><a href="{{URL::to('/product-result/'.$queryy->id_category_branch)}}">{{$categoryBranchOnly->name}}</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div>
            ...
            ?>
                <form action="{{URL::to('/comment')}}" method="GET">
                    ...
                    <br>
                    <button type="submit" class="btn-template-main">Comment</button>
                </form>
            <?php
            ...
            ?>
                <form action="{{URL::to('/admin-comment')}}" method="GET">
                    ...
                    <br>
                    <button type="submit" class="btn-template-main">Comment admin</button>
                </form>
            <?php
            } else {
            ...
            <row>
                ...
                ?>
                    <a href="{{URL::to('/delete-admin-comment/'.$eachAdminCommentList->id_coment)}}">Delete Comment</a>
                <?php
                }
                ?>
            </row>
            ...
            <row>
                ...
                ?>
                    <a href="{{URL::to('/delete-comment/'.$eachCommentList->id_coment)}}">Delete Comment</a>
                                        ...
                                        <div class="text">
                                            <p class="buttons"><a href="{{URL::to('/detail/'.$eachOfEqualProduct->id_product) }}" class="btn btn-template-outlined-white">Show Detail</a>
                                                <form action="{{URL::to('/save-cart')}}" method="GET">
                                                    ...
                                                    <p class="bottons">
                                                        <button type="submit" class="btn btn-template-outlined-white"><i class="fa fa-shopping-cart"></i> Add to cart
                                                        </button>
                                                    </p>
                                                </form>
                                            </p>
            ...
            ?>
            <h1>Compare prices between lessors</h1>
            <div class="row portfolio text-center">
                <?php
                $equalProduct = DB::table('product')
