@extends('welcome')
@section('content')
    <section style="background: url('public/frontend/img/photogrid.jpg') center center repeat; background-size: cover;"
                    ...
                    <div class="homepage owl-carousel">
                        <div class="item">
                            <div class="row">
                                ...
                                <div class="col-md-7"><img src="img/1-main-image-PAR01.jpg" alt="" class="img-fluid  ">
                                </div>
                            </div>
                        </div>
                        <!-- <div class="item">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="box-simple">
                        ...
                        <p>Save money on buying goods and still be able to experience the latest gadgets and
                            technology</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="box-simple">
                        ...
                        <h3 class="h4">Home</h3>
                        <p>We come to you. Home rental support, customers do not need to go to the store to order.
                            Customers can order online on the web.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="box-simple">
                        ...
                        <p>The company has many stores in many countries. Customers can order in different
                            countries.</p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="box-simple">
                        ...
                        <p>Economical, intelligent delivery service. Ensure goods are delivered to customers as quickly
                            as possible and cheap</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="box-simple">
                        ...
                        <p>The company supports direct advice to customers 24/7. Customers can call directly, or send
                            mail to receive support</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="box-simple">
                        ...
                        <p>The company's staff are enthusiastic people, dedicated to the job. Serving satisfied
                            customers is our pleasure</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="bar background-white">
        <div class="container text-center">
            <?php
            $provin = Session::get('idprovince') ? Session::get('idprovince') : '' ;
            ?>
            {{--        <div class="heading text-center">--}}
            {{--            <h2>Why choose us?</h2>--}}
            {{--        </div>--}}
            {{--        <p class="lead">6 Good reasons & exceptional service with a smile!</p>--}}
                        ...
                        $equalNews = DB::table('news')
                            ...
                            ->where('product.id_province', $provin)
                        ...
                        <div class="row portfolio text-center">
                            ...
                            $equalProduct = DB::table('product')
                                ->where('id_province', $provin )
                                ->orderBy('times_rent', 'DESC')  //Số lần đã thuê giảm dần
                                ->take(10)
                            ...
                            <div class="col-md-3">
                                <div class="box-image">
                                    <div class="image"><img
                                            src="{{ URL::to('/') }}/public/image/{{$url}}{{$eachOfEqualProduct->image}}"
                                            alt="" class="img-fluid">
                                ...
                                <div>
                                    ...
                                    <?php
                                    $tenNgChoThue = DB::table('customer')->where('id_customer',$eachOfEqualProduct->id_customer)->get()->first()->name;
                                    ?>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="home-blog-post">
                        <div class="image"><img
                                src="{{ URL::to('/') }}/public/image/tv & audio/TVs/n5500_si_hisense_television_01_l-1.jpg"
                                alt="..." class="img-fluid">
                        ...
                        <div class="text">
                            ...
                            <p class="intro"></p><a href="{{ URL::to('/branch-result/2') }}"
                                                    class="btn btn-template-outlined">Show all</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="home-blog-post">
                        <div class="image"><img
                                src="{{ URL::to('/') }}/public/image/technology/Computing/ASUS-Chromebook-Flip-C213-1.jpg"
                                alt="..." class="img-fluid">
                            <div class="overlay d-flex align-items-center justify-content-center"><a href="#"
                                                                                                     class="btn btn-template-outlined-white"><i
                                        class="fa fa-chain"> </i> Read More</a></div>
                        ...
                        <div class="text">
                            ...
                            <!-- <p class="author-category">By <a href="#">John Snow</a> in <a href="blog.html">Webdesign</a></p> -->
                            <p class="intro"></p></p><a href="{{ URL::to('/branch-result/3') }}"
                                                        class="btn btn-template-outlined">Show all</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="home-blog-post">
                        <div class="image"><img
                                src="{{ URL::to('/') }}/public/image/Furniture/Dining Room/Carina-Dining-Set.jpg"
                                height="172px" alt="..." class="img-fluid">
                            <div class="overlay d-flex align-items-center justify-content-center"><a href="#"
                                                                                                     class="btn btn-template-outlined-white"><i
                                        class="fa fa-chain"> </i> Read More</a></div>
                        </div>
                        <div class="text">
                            ...
                            <!-- <p class="author-category">By <a href="#">John Snow</a> in <a href="blog.html">Webdesign</a></p> -->
                            <p class="intro"></p><a href="{{ URL::to('/branch-result/4') }}"
                                                    class="btn btn-template-outlined">Show all</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="home-blog-post">
                        <div class="image"><img
                                src="{{ URL::to('/') }}/public/image/Applications/Cookers & Microwaves/Daewoo-KOC9Q4T-e1518714988146.jpg"
                                height="172px" alt="..." class="img-fluid">
                            <div class="overlay d-flex align-items-center justify-content-center"><a href="#"
                                                                                                     class="btn btn-template-outlined-white"><i
                                        class="fa fa-chain"> </i> Read More</a></div>
                        ...
                        <div class="text">
                            ...
                            <!-- <p class="author-category">By <a href="#">John Snow</a> in <a href="blog.html">Webdesign</a></p> -->
                            <p class="intro"></p><a href="{{ URL::to('/branch-result/1') }}"
                                                    class="btn btn-template-outlined">Show all</a>
                        </div>
                    </div>
                </div>
    ...
    <div class="get-it">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 text-center p-3"><a href="#" class="btn btn-template-outlined-white">Please come
                        with us</a></div>
            </div>
        </div>
    </div>
