        ...
        <div id="basket" class="col-lg-9">
            <div class="box mt-0 pb-0 no-horizontal-padding">
                <div class="table-responsive">
                    <table class="table">
                        ...
                        @foreach($content as $eachContentItem)
                            <tr>
                            <td><a href="#"><img src="img/detailsquare.jpg" alt="{{$eachContentItem->name}}" class="img-fluid"></a></td>
                                <td><a href="#">{{$eachContentItem->name}}</a></td>
                                <td>
                ...
                <div class="box-footer d-flex justify-content-between align-items-center">
                    <div class="left-col"><a href="{{URL::to('/home')}}" class="btn btn-secondary mt-0"><i class="fa fa-chevron-left"></i> Continue shopping</a></div>
                    <div class="right-col">
                      ...
                      ?>
                      <a class="btn btn-template-outlined" href = {{URL::to($href)}}>Proceed to checkout <i class="fa fa-chevron-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
