...
<section id="cart_items">
    <div class="container">
        ...
        <ul>
            ...
            ?>
            <li>Name: <span>{{$custome->name}}</span></li>
            <li>Email : <span>{{$shipping_email}}</span></li>
            <li>Phone Number: <span>{{$shipping_phone}}</span></li>
            <li>Note: <span>{{$shipping_notes}}</span></li>
            <li>Payment methods: <span>{{$payment_option}}</span></li>
        </ul>
        ...
        <table class="table table-condensed">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{DB::table('partner_delivery')->where('id_partner_delivery',$id_partner_delivery)->get()->first()->name}}</td>
                    <td>{{$shipping_fee}}</td>
                </tr>
                @endforeach
            </tbody>
        ...
        <ul>
            ...
            <li>total <span>{{$totalcost.' '.'vnđ'}}</span></li>
            {{Cart::destroy()}}
        </ul>
