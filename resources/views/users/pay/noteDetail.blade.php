                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="shipping_email"
                                               placeholder="Email" value="{{$customerInformation->email}}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="shipping_phone"
                                               placeholder="Phone" value="{{$customerInformation->phone_number}}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <table class="table">
                                    ...
                                    @foreach($content as $eachContentItem)
                                        <tr>
                                            ...
                                            <td>
                                                {{$month[$i]}}
                                                <input hidden id="months[{{$i}}]" name="months[{{$i}}]"
                                                       style="float: left;" value="{{$month[$i]}}">
                                            </td>
                                            <td>
                                                <?php
                                            ...
                                            <td>
                                                ...
                                                @elseif($shipping_method[$i] == 2)
                                                    <div>Giao hàng đến tận nơi Yêu cầu shipper đến lấy hàng khi trả đồ
                                                    </div>
                                                @endif
                                                <input hidden id="shipping_method[{{$i}}]"
                                                       name="partner_delivery[{{$i}}]" style="float: left;"
                                                       value="{{$shipping_method[$i]}}">
                                            </td>
